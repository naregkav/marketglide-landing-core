...
const CommunitySection = () => {
  ...
  return (
    <section id="community" className="py-24 bg-gradient-to-b from-background via-muted/30 to-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 space-y-6 animate-fade-in">
          <Badge variant="secondary" className="px-4 py-2 bg-gradient-to-r from-primary/10 to-accent/10 border-primary/20">
        ...
        {/* Upcoming Events */}
        <div className="bg-card border border-border rounded-2xl p-8 mb-12 animate-fade-in" style={{ animationDelay: "600ms" }}>
