...
const FeaturesGrid = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Get instant responses and deal matching through Sophia, our intelligent WhatsApp AI agent.",
    },
    {
      icon: MessageSquare,
    ...
    <section id="product" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">Built for smarter fundraising & investing.</p>
        </motion.div>
