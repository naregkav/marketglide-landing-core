  ...
  const benefits = [
    {
      ...
      description:
        "Access opportunities aligned with your mandate, all vetted through a structured onboarding process.",
    },
    {
      icon: Globe,
    ...
    },
    {
      ...
      description:
        "Collaborate on larger tickets, discover fund syndications, and access joint participation opportunities.",
    },
    {
      icon: Award,
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg text-primary-foreground/80 mb-10 leading-relaxed max-w-3xl mx-auto">
              Whether you're deploying growth capital, seeking strategic buyouts, or backing next-gen founders,
              MarketGlide gives you access to a high-signal environment designed for top investors.
            </p>
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                    All users undergo verification. Baseline checks ensure you're connecting with legitimate, qualified
                    counterparties. Our platform aligns with regulatory standards, providing the institutional
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-foreground mb-6">
              Stay Ahead with{" "}
              <span className="bg-gradient-accent bg-clip-text text-transparent">Market Intelligence</span>
            </h2>
            <p className="text-xl text-muted-foreground mb-12 leading-relaxed">
              Join a community of leading investors. See trending sectors, connect with co-investors, and leverage peer
              intelligence to make smarter decisions faster.
            </p>
